...
:remove_temp
del /s result result2 tmp .console_history 2>nul
...
if "%returned%"=="true" (
    ...
    echo.
    echo.
    echo [90m[[92m*[90m] [37m Restarting your server [37m
    echo [90m[[92m*[90m] [37m Server Address[30m"[36m%ip:~10,25%:%port:~12,20%[30m"[37m
    echo [90m[[92m*[90m] [37m Public Server Address[30m"[36m%ExtIP%:%port:~12,20%[30m"[37m
    timeout 2 >nul 2>&1
    echo.
    echo.
    goto exec%status_int%
                ...
                if "!pointerver!"=="false" (
                  ...
                  if "!arg_12!"=="" (
                    ...
                    if "!arg_10!"=="--purpur" (
                      ...
                      timeout 1 >nul 2>&1
                      curl -ks "https://api.purpurmc.org/v2/purpur/1.18.2/latest/download" -o "!arg_10:~2,25!.jar"
                    ) else if "!arg_10!"=="--waterfall" (
                      echo [90m[[96m*[90m] [37m Downloading....
                      timeout 1 >nul 2>&1
                      curl -ks "https://api.purpurmc.org/v2/projects/waterfall/1.18.2/latest/download" -o "!arg_10:~2,25!.jar"
                    ) else if "!arg_10!"=="--spigot"  (                     
                      echo [90m[[31m?[90m] [37m Error cannot download the file for spigot..
                    )
                  ) else (
                    >nul findstr "\!arg_12!" versions.json && ( set "returned=true") || ( set "returned=false")
                    if "!returned!"=="true" (
                      if "!arg_12!"=="1.19" (
